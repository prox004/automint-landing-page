...
const baseNotifications: Item[] = [
  {
    name: "New Invoice Created",
    description: "AutoBill deployed to blockchain",
    time: "3 min ago",
    icon: "✅",
    color: "#00C9A7",
  },
...
// Repeat 3 base notifications to simulate continuous feed
...
const Notification = ({ name, description, icon, color, time }: Item) => {
  return (
    <figure
      className={cn(
        "relative mx-auto w-full max-w-[600px] cursor-pointer overflow-hidden rounded-2xl p-4",
    ...
    >
      <div className="flex flex-row items-center gap-4">
        ...
        <div className="flex flex-col overflow-hidden">
          <figcaption className="flex flex-row items-center text-lg font-semibold dark:text-white">
